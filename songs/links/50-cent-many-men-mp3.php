<?php 
  ...
  include '../../conn.php';
  session_start();
  $link ='http://localhost/projects/mp/songs/links/50-cent-many-men-mp3.php';
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header section-header-new">
          ...
          <?php
            ...
            $sql = "SELECT * FROM songs WHERE link = '$link'";
            $result = mysqli_query($conn,$sql);
              $row = mysqli_fetch_array($result);

              $artist = $row['artist'];
              $title = $row['title'];
              echo"<p><span class='aotw'>$artist</span> $title Official mp3</p>";
            ...
            <div class='col-md-5 mx-auto' data-aos='fade-up' data-aos-delay='100'>
              <div class='topten-col'>
                ...
                <h2 class='title'>
                  <div class='col-12'>
                    <div id='player'>
                      <audio src='../$song' id='audioFile'></audio>
                      <button id='playButton' class='btn btn-sm btn-success' onclick='playFile()'>
                        <i class='bi bi-play'></i>
                      </button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                      <button class='btn btn-sm btn-success' onclick='download()'>
