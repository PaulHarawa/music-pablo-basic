          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Genre</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  <li><a href="afro.php">Afro Pop</a></li>
                  <li><a href="dancehall.php">Dance Hall</a></li>
                  <li><a href="hiphop.php" class="active">Hip Hop</a></li>
    ...
    <section id="topten">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-12 box1" data-aos="fade-up" data-aos-delay="100">
            ...
            $sql = "SELECT * FROM songs WHERE genre='HipHop' ORDER BY artist";
              ...
              <div class='col-12 col-lg-4 col-md-4 boxSmall p-2'>
                <div class='single-artist'>
                  ...
                  <div class='col-9 small-box-one'>
                    <p><span class='aname'><a href='$link'>$artist</a></span><br><span class='sname'>$title</span></p>
                  </div>
                </div>
              </div>
