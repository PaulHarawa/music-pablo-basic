  ...
  <main id="main">
    ...
    <section id="topten">
      <div class="container" data-aos="fade-up">
        ...
        $sql = "SELECT * FROM songs WHERE artist='$noa'";
          ...
          <div class='col-md-4' data-aos='fade-up' data-aos-delay='100'>
            <div class='topten-col'>
              <div class='img'>
                ...
                <form action='kendrick-lamar.php' method='POST' enctype='multipart/form-data'>
                  <a class='icon' href='$link'><i class='bi bi-play'></i></a>
                  <input type='radio' name='songId' value='$id' checked hidden>
                </form>
              </div>
              <form action='a-reece.php' method='POST' enctype='multipart/form-data'>
                <h2 class='title'><a href='$link' class='songButton'>$artist - $title</a></h2>
                <input type='radio' name='songId' value='$id' checked hidden>
              </form>
              <p class='text-center'>
